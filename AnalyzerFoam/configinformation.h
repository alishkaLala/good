...
public:
        ...
        static qint32 getSizeWindowCaptureMinimum();
        static qint32 getSizeWindowCaptureMaximum();
        ...
        static qint32 getperiodCaptureMinimum();
        static qint32 getperiodCaptureMaximun();
