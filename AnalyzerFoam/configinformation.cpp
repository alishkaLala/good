...
{
  sizeWindowCaptureMinimum=100;
  sizeWindowCaptureMaximum=25000;
...
qint32 configInformation::getSizeWindowCaptureMinimum()
{
  return  sizeWindowCaptureMinimum;
}

qint32 configInformation::getSizeWindowCaptureMaximum()
{
  return sizeWindowCaptureMaximum;
}
...
qint32 configInformation::getperiodCaptureMinimum()
{
  return periodCaptureMinimum;
}

qint32 configInformation::getperiodCaptureMaximun()
{
  return periodCaptureMaximum;
}
